"""scrum_master_19191 URL Configuration
...
admin.site.site_header = "Scrum Master"
admin.site.site_title = "Scrum Master Admin Portal"
admin.site.index_title = "Scrum Master Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version="v1",
        description="API documentation for Scrum Master App",
    ),
    public=True,
